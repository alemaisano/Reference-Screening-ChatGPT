...
sleep_between_calls <- 20  # 1 minuto tra chiamate

input_file          <- "database_output_raw/scopus_export_prototype_1.csv"
resume_file_csv     <- "output/screened_step1.1_groq2_resumed12.csv"
output_file_csv     <- "output/screened_step1.1_groq2_resumed13.csv"
output_file_tsv     <- "output/screened_step1.1_groq2_resumed13.txt"
prompt_file         <- "prompts/prototype2_roadnet_biodconnectivity.txt"

resume_from_code    <- "P1345"
